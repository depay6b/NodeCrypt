...
const LANGUAGES = {
	en: {
		...
		translations: {
			...
			'settings.history': 'History Settings',
			...
			'settings.history_retention': 'Message History Retention',
			'settings.history_1h': '1 Hour',
			'settings.history_6h': '6 Hours',
			'settings.history_12h': '12 Hours',
			'settings.history_24h': '24 Hours',
			'settings.history_3d': '3 Days',
			'settings.history_1w': '1 Week',
	...
	zh: {
		...
		translations: {
			...
			'settings.history': '历史记录设置',
			'settings.desktop_notifications': '桌面通知',
			'settings.sound_notifications': '声音通知',
			'settings.language_switch': '语言',
			'settings.chinese': '中文',
			'settings.english': 'English',
			'settings.history_retention': '消息历史保留时间',
			'settings.history_1h': '1 小时',
			'settings.history_6h': '6 小时',
			'settings.history_12h': '12 小时',
			'settings.history_24h': '24 小时',
			'settings.history_3d': '3 天',
			'settings.history_1w': '1 周',
